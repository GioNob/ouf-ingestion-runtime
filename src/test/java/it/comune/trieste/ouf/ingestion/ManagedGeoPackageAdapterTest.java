...
class ManagedGeoPackageAdapterTest {
  ...
  private List<AdapterSpi.SourceRecord> read(String fixture,Map<String,Object> checkpoint)throws Exception{
    ...
    var config=Map.<String,Object>of("expectedSize",bytes.length,"expectedHash",hash,"layer","cameras","sourceCrs","EPSG:4326","geometryColumn","geom","identityFields",List.of("code"),"maxRows",100,"maxCellChars",1000);
