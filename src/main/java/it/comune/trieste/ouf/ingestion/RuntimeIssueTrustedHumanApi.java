...
public class RuntimeIssueTrustedHumanApi {
  ...
  @GetMapping("/{id}/explain") Map<String,Object> explain(@PathVariable UUID id,HttpServletRequest request){return issues.explain(id,authorization.require(request,"ouf.ingestion.issue.explain",false));}
