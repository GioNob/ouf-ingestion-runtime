...
public class RunStateRepository {
  ...
  private static String phase(String acquisition){return switch(acquisition){case "MANAGED","INTERNAL_MANAGED_CSV","INTERNAL_MANAGED_XLSX"->"MANAGED_ONCE";case "REPLAY"->"REPLAY";default->"FULL_SNAPSHOT";};}
