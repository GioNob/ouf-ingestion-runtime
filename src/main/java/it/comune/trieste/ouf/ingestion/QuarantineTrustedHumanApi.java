...
public class QuarantineTrustedHumanApi {
  ...
  public record ReplayRequest(String targetBundleRef){}public record RetryRequest(long expectedVersion){}public record CloseRequest(String reason,String supersededBy,long expectedVersion){}
